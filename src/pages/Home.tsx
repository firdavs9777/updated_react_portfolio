...
export const HomePage: React.FC = () => {
  ...
  const specialties = [
    ...
    },
    {
      title: tx({
        ...
        ko: "성능 최적화",
        uz: "Samaradorlikni optimallashtirish",
      }),
      description: tx({
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-r from-green-500 to-emerald-600 text-white py-2.5 text-center text-sm font-medium mt-16 relative overflow-hidden">
        ...
        <div className="relative flex items-center justify-center gap-2">
          ...
          <span>
            {tx({
              en: "Open to Work — Available for full-time positions and freelance projects",
              ko: "구직 중 — 정규직 및 프리랜서 프로젝트 가능합니다",
              uz: "Ishga tayyor — Doimiy ish va freelance loyihalar uchun tayyorman",
            })}
          </span>
          <button
            onClick={() => navigate("/contact")}
            className="ml-3 px-3 py-0.5 bg-white text-green-700 rounded-full text-xs font-bold hover:bg-green-50 transition-colors"
          >
            {tx({ en: "Contact Me", ko: "연락하기", uz: "Bog'lanish" })}
          </button>
        </div>
      </div>

      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <div className="flex pt-24 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {/* BananaTalk Card */}
            ...
            <div className="text-center">
              ...
              <div className="mb-16 px-2 sm:px-0">
                <div className="text-center mb-8">
                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-medium mb-4">
                    ...
                    {tx({
                      en: "Live & Serving Users",
                      ko: "실제 운영 중",
                      uz: "Katta loyihalar va foydalanuvchilarga xizmat qilmoqda",
                    })}
                  </div>
                ...
                <div className="text-center mt-8">
                  ...
                  >
                    {tx({
                      en: "View All Live Projects",
                      ko: "모든 라이브 프로젝트 보기",
                      uz: "Barcha Katta Loyihalarni ko'rish",
                    })}
              ...
              <div className="mb-16 px-2 sm:px-0">
                <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-6 sm:mb-8">
                  {tx({
                    en: "What I Specialize In",
                    ko: "전문 분야",
                    uz: "Mutaxassislik sohalarim",
                  })}
                </h3>
