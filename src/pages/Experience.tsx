  ...
  const experiences = [
    {
      ...
      achievements:
        language === "ko"
          ? [
              "다양한 풀스택 기술을 활용한 새로운 도전 기회 모색 중",
              "React, Vue.js, Flutter 등 최신 기술 스택에 대한 전문성 보유",
              "백엔드부터 프론트엔드까지 전체 개발 프로세스 경험",
              "혁신적인 프로젝트에 기여할 준비가 된 열정적인 개발자",
              "빠른 학습 능력과 문제 해결 능력으로 팀에 즉시 기여 가능",
            ]
          : [
              "Actively seeking new opportunities to leverage full-stack development expertise",
              "Proficient in modern tech stacks including React, Vue.js, Flutter, and more",
              "Experienced in end-to-end development from backend to frontend",
              "Passionate developer ready to contribute to innovative projects",
              "Quick learner with strong problem-solving skills, ready to make immediate impact",
            ],
    },
    {
      id: 2,
