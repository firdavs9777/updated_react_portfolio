        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 animate-fade-in-up">
          ...
          <div className="border-l-4 border-blue-600 pl-6">
            ...
            <p className="text-gray-600 mt-2">
              <strong>Key Subjects:</strong> Software Engineering, Database
              Systems, Algorithms, Web Programming, Team Project Management
            </p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Advanced Korean language and cultural integration
                  certification
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Recognition for exceptional teamwork and project delivery
                </p>
              </div>
            </div>
          </div>
